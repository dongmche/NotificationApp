...
import DeleteCustomersApi from '../api/DeleteCustomersApi';
...
export default function EnhancedTable() {
  ...
  React.useEffect(() => {
    ...
    const getData = async () => {
      if(query == null){
        console.log("query is a null");
        const data = await FetchCustomersApi({});
        setCustomers(data);
      } else{
        console.log("so it is not null");
        const data = await FetchCustomersApi({query});
        setCustomers(data);
      }
    };
  ...
  const handleClick = (event, id) => {
    ...
    setSelected(newSelected);
    console.log(`Selected item ID: ${id}`); // Print the selected item's ID
  };
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="left">
                      <Button 
                        variant="outlined" 
                        onClick={(event) => handleCustomerClick(event, row.id)}
